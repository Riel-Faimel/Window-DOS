...
include $(SRC_DIR)bootloader/LAS/LAS.mk
...
$(BUILD_DIR)bootloader/_start.o: $(SRC_DIR)bootloader/_start.asm
$(BUILD_DIR)bootloader/boot.bin: $(SRC_DIR)bootloader/boot.asm

$(BUILD_DIR)bootloader.bin: $(OBJECTS)\
	$(BUILD_DIR)bootloader/_start.o\
